...
unsafe extern "system" fn get_root_screen_rect<I: RenderHandler>(
    this: *mut cef_render_handler_t, _browser: *mut cef_browser_t, _rect: *mut cef_rect_t,
) -> ::std::os::raw::c_int {
...
unsafe extern "system" fn on_cursor_change(
    _this: *mut cef_render_handler_t, _browser: *mut cef_browser_t, _cursor: HCURSOR,
...
unsafe extern "system" fn on_scroll_offset_changed(
    _this: *mut cef_render_handler_t, _browser: *mut cef_browser_t, _x: f64, _y: f64,
) {
}
